...
- [OmegaWiki](https://github.com/skyllwt/OmegaWiki) - Wiki-first research platform on Claude Code covering the full cycle: literature ingest → ideation → experiments → paper drafts, with interactive knowledge graph
