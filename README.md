...
- [AutoZyme](https://github.com/ElliotXie/autozyme) - Autonomous multi-agent framework that speeds up scientific software (Scanpy, Seurat, and other CPU-bound code) through a profile→optimize→benchmark→keep-or-revert loop, preserving original results via a strict output-equivalence check; Python/R/C++ (UW-Madison, MIT License, 2026)
