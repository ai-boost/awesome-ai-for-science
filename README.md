...
- [EurekAgent](https://github.com/THU-Team-Eureka/EurekAgent) - Autoresearch system for metric-driven autonomous scientific discovery, using environment engineering to equip coding agents (e.g., Claude Code) with resources, constraints, artifacts, budgets, and human interfaces for reliable end-to-end experimentation (THU Team Eureka, arXiv 2026, AGPL-3.0)
