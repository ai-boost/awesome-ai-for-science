...
- [Matcha](https://github.com/LigandPro/Matcha) - Multi-stage Riemannian flow matching pipeline for protein-ligand molecular docking, combining geometric pose refinement with physical validity filtering (arXiv 2025)
