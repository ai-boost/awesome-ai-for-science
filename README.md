...
*Last updated: June 2026 - Enhanced with 2025-2026 breakthroughs in autonomous research, equation discovery, scientific foundation models, spatial transcriptomics agents, biomedical image analysis foundation models, and deep potential molecular dynamics; added HEST to Computational Pathology & Digital Pathology; added VoxTell to Medical AI & Clinical Applications; added BiaPy to Medical AI & Clinical Applications; added InstanSeg to Medical AI & Clinical Applications; added Open Targets to Protein & Drug Discovery; added TimesFM to Foundation Models for Science; added PantheonOS to Research Agents & Autonomous Workflows; added gRNAde to Genomics & Bioinformatics; added exponax to Scientific Machine Learning; added sbi to Scientific Machine Learning; added FunSearch to Research Agents & Autonomous Workflows; added pymatgen to Chemistry & Materials; added TESSERA to Earth & Climate Science; added nnU-Net to Biology & Medicine; added OpenCRISPR to Biology & Medicine; added Camyla to Research Agents; added TRIBE v2 to Biology & Medicine; added SciWrite to Research Workbench & Plugins; added Chroma to Biology & Medicine; added AlphaMissense to Genomics & Bioinformatics; added Clay Foundation Model to Remote Sensing & Geospatial AI; added MONAI to Medical AI & Clinical Applications; added TotalSegmentator to Medical AI & Clinical Applications; added LeanDojo to Domain-Specific Research Agents; added Biomni to Domain-Specific Research Agents; added TxAgent to Domain-Specific Research Agents; added ScienceBoard to Research Agents Evaluation & Benchmarking; added RFantibody to Biology & Medicine; added NewtonBench to Research Agents Evaluation & Benchmarking; added HelixFold3 to Protein & Drug Discovery; added Genie 2 to Protein & Drug Discovery; added Genie 3 to Protein & Drug Discovery; added MLE-Bench to Research Agents Evaluation & Benchmarking; added Stack to Genomics & Bioinformatics; added UNI, Prov-GigaPath, CONCH, and PLIP to Computational Pathology & Digital Pathology; added Virchow to Computational Pathology & Digital Pathology; added MedSAM2 to Medical AI & Clinical Applications; added PLACER to Protein & Drug Discovery; added CEBRA to Neuroscience & Behavioral Analysis; added TorchGeo to Remote Sensing & Geospatial AI; added AION to Astronomy & Astrophysics; added SchNetPack to Chemistry & Materials; added micro-sam to Medical AI & Clinical Applications; added LigandMPNN to Protein & Drug Discovery; added AlphaGenome to Genomics & Bioinformatics; added REINVENT to Protein & Drug Discovery; added Poseidon to Scientific Machine Learning; added TITAN to Computational Pathology & Digital Pathology; added PaperBanana to Paper→Poster / Slides / Graphical Abstract; added NeuralPLexer to Protein & Drug Discovery; added Lean Copilot to Domain-Specific Research Agents; added Foldseek to Protein & Drug Discovery; added OpenEvolve to Research Agents & Autonomous Workflows; added olmOCR to Scientific Documentation & Parsing; added La-Proteina to Protein & Drug Discovery; added AIRS-Bench to Research Agents Evaluation & Benchmarking; added DPLM to Protein & Drug Discovery; added HyenaDNA to Genomics & Bioinformatics; added SevenNet to Chemistry & Materials; added DynamicBind to Protein & Drug Discovery; added Virtual Lab to Research Agents & Autonomous Workflows; added mLLMCelltype to Genomics & Bioinformatics; added Claude Prism to Scientific Writing & Collaboration; added AlphaProteo to Protein & Drug Discovery; added AlphaFlow to Protein & Drug Discovery; added cellSAM to Medical AI & Clinical Applications; added pykan to Scientific Machine Learning; added Helical to Genomics & Bioinformatics; added Allegro to Chemistry & Materials; added AlphaQubit to Physics & Astronomy; added SciAgents to Domain-Specific Research Agents; added ai-models (ECMWF) to Earth & Climate Science; added BioCLIP to Agriculture & Ecology; added ZeroCostDL4Mic to Medical AI & Clinical Applications; added DeepVariant to Genomics & Bioinformatics; added TorchDrug to Protein & Drug Discovery; added TerraMind to Remote Sensing & Geospatial AI; added Casanovo to Genomics & Bioinformatics; added TRIDENT to Computational Pathology & Digital Pathology; added llm-for-zotero to Research Workbench & Plugins; added Microsoft Biodiversity to Agriculture & Ecology; added dynamicPDB to Protein & Drug Discovery; added ImmunoStruct to Protein & Drug Discovery; added AgentSociety to Social Sciences; added STORM to Scientific Literature RAG & Analysis; added Caduceus to Genomics & Bioinformatics; added EvoDiff to Protein & Drug Discovery; added ProteinGym to Datasets & Benchmarks; added OpenFold to Protein & Drug Discovery; added napari to Medical AI & Clinical Applications; added DNABERT-2 to Genomics & Bioinformatics; added GAOT to Scientific Machine Learning; added FuXi to Earth & Climate Science; added AiCE to Protein & Drug Discovery; added EVOLVEpro to Protein & Drug Discovery; added JARVIS to Chemistry & Materials; added PyTorch Geometric to Specialized Frameworks; added SeisBench to Earth & Climate Science; added Nicheformer to Genomics & Bioinformatics; added PathChat to Computational Pathology & Digital Pathology; added InterPLM to Protein & Drug Discovery; added AIDE to Research Agents & Autonomous Workflows; added HealthGPT to Medical AI & Clinical Applications; added OpenBioMed to Research Workbench & Plugins; added AutoR to Research Workbench & Plugins; added braindecode to Neuroscience & Behavioral Analysis; added JAX-CFD to Specialized Frameworks; added CellRank to Genomics & Bioinformatics; added GDM Science Skills to Research Workbench & Plugins; added Arc Virtual Cell Atlas to Datasets & Benchmarks; added SRAgent to Domain-Specific Research Agents; added GigaTIME to Computational Pathology & Digital Pathology; added RareFold to Protein & Drug Discovery; added HuatuoGPT-o1 to Foundation Models for Science; added Chronos to Foundation Models for Science; added CORAL to Research Agents & Autonomous Workflows; added BioReason to Genomics & Bioinformatics; added EDSL to Social Sciences; added ClawBio to Domain-Specific Research Agents; added Catalyst.jl to Scientific Machine Learning; added BioCLIP 2 to Agriculture & Ecology; added DGL to Specialized Frameworks; added Science-Star to Research Agents & Autonomous Workflows; added gReLU to Genomics & Bioinformatics; added PaSa to AI Tools for Research; added PlantCV to Agriculture & Ecology; added QuPath to Medical AI & Clinical Applications; added BirdNET-Analyzer to Agriculture & Ecology; added Cleanlab to Data Labeling & Curation; added ScienceClaw to Research Agents & Autonomous Workflows; added MedRAX to Medical AI & Clinical Applications; added CodeScientist to Research Agents & Autonomous Workflows; added Foam-Agent to Domain-Specific Research Agents; added BioAgents to Domain-Specific Research Agents; added ModelAngelo to Protein & Drug Discovery; added UniBiomed to Medical AI & Clinical Applications; added cellxgene to Genomics & Bioinformatics; added Qiskit to Specialized Frameworks; added AutoScientists to Research Agents & Autonomous Workflows; added DiffPhysDrone to Physics & Astronomy; added snntorch to Neuroscience & Behavioral Analysis; added ProteinWorkshop to Datasets & Benchmarks; added ProstT5 to Protein & Drug Discovery*
